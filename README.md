...
To update the database use this command from the Web project folder (replace `url_alter_backend` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../url_alter_backend.Infrastructure/url_alter_backend.Infrastructure.csproj -s url_alter_backend.Web.csproj
```
